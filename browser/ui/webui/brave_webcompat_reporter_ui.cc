...
#include "brave/browser/ui/webui/brave_webcompat_reporter_ui.h"
...
#include "brave/browser/webcompat_reporter/webcompat_reporter_service.h"
...
BraveWebcompatReporterUI::BraveWebcompatReporterUI(content::WebUI* web_ui, const std::string& name)
...
BraveWebcompatReporterUI::~BraveWebcompatReporterUI() {
}

...
#ifndef BRAVE_BROWSER_ANDROID_REWARDS_SAFETYNET_CHECK_H_
#define BRAVE_BROWSER_ANDROID_REWARDS_SAFETYNET_CHECK_H_
...
#endif  // BRAVE_BROWSER_ANDROID_REWARDS_SAFETYNET_CHECK_H_
